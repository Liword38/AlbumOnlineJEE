...
@Named
@RequestScoped
public class UnshareAlbum {
    
    private SempicAlbum target;
    
    private Set<SempicGroup> unshareGrp;
    ...
    public void setUnshareGrp(Set<SempicGroup> unshareGrp) {
        this.unshareGrp = unshareGrp;
    }
    
    public Set<SempicGroup> getUnshareGrp() {
        return this.unshareGrp;
    }
    ...
    public void unshare() {
        ...
        System.out.println(unshareGrp);
        
        unshareGrp.forEach((e) -> groupDao.deleteAlbum(e.getId(), Long.parseLong(albumId)));
